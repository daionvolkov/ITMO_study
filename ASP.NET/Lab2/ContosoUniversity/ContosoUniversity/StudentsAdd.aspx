...
<h2>Add New Students </h2>
        ...
        <asp:EntityDataSource ID="StudentsEntityDataSource" runat="server" 
            ...
            EnableDelete="True" EnableFlattening="False" EnableUpdate="True" EnableInsert="True" 
            EntitySetName="People" Include="StudentGrades">

        </asp:EntityDataSource>

    <asp:DetailsView ID="StudentsDetailsView" runat="server"
        DataSourceID="StudentsEntityDataSource" AutoGenerateRows="False"    DefaultMode="Insert">
   <Fields>
